...
#ifndef GN_JUMBO_WRITER_H_
#define GN_JUMBO_WRITER_H_
...
class JumboWriter {
 ...
 private:
  ...
  JumboWriter(const JumboWriter&) = delete;
  JumboWriter& operator=(const JumboWriter&) = delete;
};

#endif  // GN_JUMBO_WRITER_H_
