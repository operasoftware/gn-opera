...
#ifndef TOOLS_GN_JUMBO_FILE_LIST_GENERATOR_H_
#define TOOLS_GN_JUMBO_FILE_LIST_GENERATOR_H_
...
class JumboFileListGenerator {
 ...
 private:
  ...
  Target::JumboSourceFile* FindJumboFile(SourceFileType file_type) const;

  // Creates a new JumboSourceFile object for given |file_type| and adds it to
  // |jumbo_files_|.
  Target::JumboSourceFile* CreateJumboFile(SourceFileType file_type);
  ...
  // source file type.
  std::map<SourceFileType, int> jumbo_file_numbers_;

  // Recently used jumbo file and its type.
  Target::JumboSourceFile* recent_jumbo_file_;
  SourceFileType recent_jumbo_file_type_;
...
#endif  // TOOLS_GN_JUMBO_FILE_LIST_GENERATOR_H_
